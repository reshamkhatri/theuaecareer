...
const pathwayCatalog: SeoPathwayLink[] = [
  ...
  {
    href: '/blog/how-to-find-a-job-in-dubai-as-a-fresher/',
  ...
  {
    href: '/blog/walk-in-interviews-dubai-this-week/',
    title: 'This week’s Dubai walk-in interviews',
    description: 'Use the weekly walk-in roundup when you need the fastest in-person hiring route.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['walk-in', 'general'],
    intentClusters: ['walk-in-prep'],
  ...
  {
    href: '/blog/uae-labour-law-guide-for-expats/',
  ...
  {
    href: '/blog/driver-salary-in-uae-2026/',
  ...
  {
    href: '/blog/best-free-zones-dubai-2026/',
    title: 'Compare Dubai free zones',
    description: 'Use the comparison guide when you need a clearer view of setup costs and business fit.',
