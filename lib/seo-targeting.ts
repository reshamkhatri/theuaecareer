...
const pathwayCatalog: SeoPathwayLink[] = [
  ...
  {
    href: '/blog/how-to-renew-uae-work-visa-2026/',
    title: 'Renew your UAE work visa with less stress',
    description: 'See the usual renewal steps, timing, and documents before your employer starts the process.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['visa-documents', 'general'],
    intentClusters: ['application-workflow'],
    searchStages: ['discover', 'apply'],
    priority: 7,
  },
  {
    href: '/blog/how-to-find-a-job-in-dubai-as-a-fresher-2026/',
    title: 'Dubai fresher job search guide',
    description: 'Learn which industries actually hire freshers and how to present your CV for your first role.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
  ...
  {
    href: '/jobs/walk-in/',
    title: 'Dubai walk-in interview jobs',
    description: 'Browse current walk-in interview openings and prepare before you go in person.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['walk-in', 'general'],
    intentClusters: ['walk-in-prep'],
  ...
  {
    href: '/blog/uae-labour-law-for-expats-2026/',
    title: 'UAE labour law guide for expats',
    description: 'Read the practical labour-law guide before you accept, extend, or leave a UAE job.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['salary-benefits', 'visa-documents', 'general'],
    intentClusters: ['salary-remittance-benefits', 'application-workflow'],
    searchStages: ['discover', 'compare', 'apply'],
    priority: 7,
  },
  {
    href: '/blog/driver-salary-uae-2026/',
    title: 'Driver salary in UAE',
    description: 'Compare light vehicle, heavy vehicle, and delivery driver pay before you accept an offer.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['driver-transport', 'salary-benefits'],
    intentClusters: ['salary-remittance-benefits', 'role-interview-prep'],
    searchStages: ['discover', 'compare'],
    priority: 7,
  },
  {
    href: '/blog/cost-of-living-dubai-2026/',
    title: 'Dubai cost of living guide',
    description: 'Use the budget guide to compare rent, food, transport, and realistic monthly spending.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['salary-benefits', 'general'],
    intentClusters: ['salary-remittance-benefits'],
  ...
  {
    href: '/blog/mainland-vs-free-zone-jobs-uae/',
    title: 'Mainland vs free zone jobs',
    description: 'Understand how a mainland or free zone employer affects your contract, gratuity, and rights.',
    surfaces: ['homepage', 'blog', 'resources'],
    countries: ['UAE', 'Gulf'],
  ...
  {
    href: '/blog/abu-dhabi-vs-dubai-working-expats/',
    title: 'Abu Dhabi vs Dubai for working expats',
    description: 'Compare salary, lifestyle, and commute realities before you choose a UAE base.',
    surfaces: ['homepage', 'blog', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['salary-benefits', 'general'],
    intentClusters: ['salary-remittance-benefits'],
    searchStages: ['compare'],
    priority: 6,
  },
  {
  ...
  {
    href: '/blog/uae-interview-questions-and-answers/',
    title: 'Common Gulf interview questions',
    description: 'Practice the questions employers ask most often across retail, hospitality, and service roles.',
    surfaces: ['blog', 'jobs', 'resources'],
    countries: ['Saudi Arabia', 'Gulf'],
    roleFamilies: ['retail'],
  ...
  {
    href: '/blog/housekeeping-interview-questions-dubai-hotels/',
    title: 'Hotel housekeeping interview questions',
    description: 'Use practical sample answers before hotel housekeeping interviews in the Gulf.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
  ...
  {
    href: '/blog/tell-me-about-yourself-uae-interview/',
    title: 'Nail your interview introduction',
    description: 'Prepare a confident self-introduction and answers for driver and service-role interviews.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['Qatar', 'Gulf'],
  ...
  {
    href: '/blog/salary-guide-uae-2026/',
    title: 'UAE salary guide by role',
    description: 'Check realistic UAE pay ranges across roles before you accept an offer.',
    surfaces: ['homepage', 'blog', 'jobs', 'resources'],
    countries: ['UAE', 'Gulf'],
    roleFamilies: ['salary-benefits', 'general'],
    intentClusters: ['salary-remittance-benefits'],
  ...
  {
    href: '/blog/avoid-fake-gulf-job-offers/',
  ...
  {
    href: '/blog/best-job-search-websites-in-uae-2026/',
    title: 'Best UAE job search websites',
    description: 'See which job portals and channels actually work for finding UAE jobs, and how to apply.',
    surfaces: ['blog', 'jobs', 'resources'],
    countries: ['UAE', 'Saudi Arabia', 'Qatar', 'Gulf'],
  ...
  {
    href: '/blog/best-cv-format-uae-jobs-2026/',
