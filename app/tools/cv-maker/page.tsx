      ...
      <section className="container" style={{ marginTop: '80px', maxWidth: '1000px', lineHeight: 1.8 }}>
        ...
        <div style={{ padding: '40px', background: '#0f172a', color: '#fff', borderRadius: '24px', textAlign: 'center', marginBottom: '80px' }}>
           ...
           <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '12px' }}>
              <Link href="/jobs/walk-in/" style={{ background: 'rgba(255,255,255,0.1)', padding: '10px 20px', borderRadius: '12px', color: '#fff', textDecoration: 'none', fontWeight: 600 }}>Walk-In Interviews</Link>
              <Link href="/blog/uae-labour-law-for-expats-2026/" style={{ background: 'rgba(255,255,255,0.1)', padding: '10px 20px', borderRadius: '12px', color: '#fff', textDecoration: 'none', fontWeight: 600 }}>Labour Law Guide</Link>
