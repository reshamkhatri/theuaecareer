...
export const metadata: Metadata = {
  ...
  description:
    "Find the latest jobs in UAE, Dubai, Abu Dhabi, Sharjah, and the Gulf region. Walk-in interviews, career guides, salary insights, and free AI CV maker for UAE job seekers.",
  keywords: [
    "jobs in UAE",
    "jobs in Dubai",
  ...
  twitter: {
    ...
    description:
      "Find the latest jobs in UAE, Dubai, Abu Dhabi, and the Gulf region.",
  },
  robots: {
    index: true,
    follow: true,
