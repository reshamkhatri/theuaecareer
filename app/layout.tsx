  ...
  return (
    <html lang="en" className={inter.className}>
      <head>
        ...
        {/*
          Per-page OpenGraph/Twitter metadata is generated by Next.js from each
          page's exported `metadata.openGraph` / `metadata.twitter`. Do NOT
          hardcode <meta property="og:*"> here — it overrides per-page values
          and causes duplicate OG tags on every subpage (regression introduced
          in commit 6e3c3fb on 2026-04-23, which coincided with a Search Console
          impressions cliff). Defaults live in the `metadata` export above.
        */}
        {adsensePublisherId && (
          <script
            async
