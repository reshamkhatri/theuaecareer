...
const jobListings: JobDocument[] = [
  ...
  },
  {
    ...
    isWalkIn: false,
    description: [
      paragraph('A trading company in Sharjah’s Industrial Area is hiring a Junior Accountant. This is an accounts payable / accounts receivable role with some VAT filing responsibilities.'),
      bullet('Bachelor’s degree in Accounting or Finance'),
      bullet('Proficiency in Tally or QuickBooks'),
      bullet('Good understanding of UAE VAT'),
    ],
    howToApply: [
